...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        pizza_data = {
            ...
            'Jane\'s Dough': {'dough': 1, 'olives': 10, 'rocket': 10, 'olive_oil': 5},
            'The Champ': {'dough': 1, 'pizza_sauce': 1, 'shredded_cheese': 20, 'spring_onion': 10, 'pepperoni': 15, 'olive_oil': 5},
            'Mish-Mash': {'dough': 1, 'pizza_sauce': 1, 'shredded_cheese': 20, 'goat_cheese': 10, 'rocket': 10, 'parma_ham': 15, 'fig_jam': 5},
            'Pig in Paradise': {'dough': 1, 'pizza_sauce': 1, 'shredded_cheese': 20, 'cooked_pineapple': 10, 'bacon': 15},
            'Poppa\'s Pizza': {'dough': 1, 'pizza_sauce': 1, 'fresh_mozzarella': 20, 'olives': 10, 'basil': 10, 'anchovies': 10, 'olive_oil': 5},
            'Lekkerízza': {'dough': 1, 'pizza_sauce': 1, 'shredded_cheese': 20, 'feta': 10, 'peppadew': 10, 'rocket': 10, 'chorizo': 15, 'bacon': 15},
            'Artichoke & Ham': {'dough': 1, 'pizza_sauce': 1, 'shredded_cheese': 20, 'artichoke_leaves': 10, 'olives': 10, 'mushroom': 15, 'ham': 15},
